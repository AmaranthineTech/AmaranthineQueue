...
/**
 ...
 - Version: 1.4
 */
extension AmaranthineQueue : Sequence {
...
/**
 ...
 - Version: 1.5
 */
extension AmaranthineQueue : Collection {
    public typealias SubSequence = AmaranthineQueue<Element>
    
    /**
     Enables subscripting behavior over a range of values.
     - returns: A subset of the queue `AmaranthineQueue.SubSequence`
     - requires: iOS 11 or later
     - Since: iOS 11
     - author: Arun Patwardhan
     - copyright: Copyright (c) Amaranthine 2015 - version: 1.0*/
...
/**
 ...
 - Version: 1.5
 */
extension AmaranthineQueue : ExpressibleByArrayLiteral {
